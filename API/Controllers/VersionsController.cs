                        ...
                        if (i > 0)
                        {
                            if (col > 71) {
                                var prescription = new Prescriptions
                                {
                                    ...
                                    Product_Description = rows[11].ToString() + ", " + rows[12].ToString(),
                                    Snomed_Code = rows[13].ToString(),
                                    Quantity = rows[14].ToString(),
                                    Unit_Of_Measure = rows[15].ToString(),
                                    Pack_Price = rows[16].ToString(),
                                    Pack_Size = rows[17].ToString(),
                                    Basic_Price = rows[18].ToString(),
                                    Payment_for_Consumables = rows[19].ToString(),
                                    Payment_for_Containers = rows[20].ToString(),
                                    NB = rows[21].ToString(),
                                    CC = rows[22].ToString(),
                                    DA = rows[23].ToString(),
                                    DA_Value = rows[24].ToString(),
                                    EX = rows[25].ToString(),
                                    EX_Value = rows[26].ToString(),
                                    GN = rows[27].ToString(),
                                    IP = rows[28].ToString(),
                                    IP_Value = rows[29].ToString(),
                                    LP = rows[30].ToString(),
                                    LP_Value = rows[31].ToString(),
                                    MC = rows[32].ToString(),
                                    MC_Value = rows[33].ToString(),
                                    MF = rows[34].ToString(),
                                    MI = rows[35].ToString(),
                                    MI_Value = rows[36].ToString(),
                                    MP = rows[37].ToString(),
                                    MP_Value = rows[38].ToString(),
                                    NC = rows[39].ToString(),
                                    NC_Value = rows[40].ToString(),
                                    ND = rows[41].ToString(),
                                    RB = rows[42].ToString(),
                                    RB_Value = rows[43].ToString(),
                                    SF = rows[44].ToString(),
                                    SF_Value = rows[45].ToString(),
                                    ZD = rows[46].ToString(),
                                    LB = rows[47].ToString(),
                                    LC = rows[48].ToString(),
                                    LE = rows[49].ToString(),
                                    LF = rows[50].ToString(),
                                    SDR_Professional_Fee_Value = rows[51].ToString(),
                                    SDR_Professional_Fee_Number = rows[52].ToString(),
                                    ZDR_Professional_Fee_Value = rows[53].ToString(),
                                    ZDR_Professional_Fee_Number = rows[54].ToString(),
                                    SP_Unlicensed_Meds_Fee_Value = rows[55].ToString(),
                                    ED_Unlicensed_Meds_Fee_Value = rows[56].ToString(),
                                    MF_Hosiery_Fee_Value = rows[57].ToString(),
                                    MF_Truss_Fee_Value = rows[58].ToString(),
                                    MF_Belt_and_Girdle_Fee_Value = rows[59].ToString(),
                                    Methadone_Fee_Value = rows[60].ToString(),
                                    Methadone_Pckgd_Dose_Fee_Value = rows[61].ToString(),
                                    Home_Del_SR_Appl_Add_Fee_Value = rows[62].ToString(),
                                    Home_Del_HR_Appl_Add_Fee_Value = rows[63].ToString(),
                                    CD_Schedule_2_Fee_Value = rows[64].ToString(),
                                    CD_Schedule_3_Fee_Value = rows[65].ToString(),
                                    Expensive_Item_Fee_Value = rows[66].ToString(),
                                    Stoma_Customisation_Fee_Value = rows[67].ToString(),
                                    Dispensing_UID = rows[68].ToString(),
                                    NHS_Patient_Number = rows[69].ToString(),
                                    SSP_Vat_Value = rows[70].ToString(),
                                    SSP_Fee_Value = rows[71].ToString(),
                                    DocsId = docOut
                                };
